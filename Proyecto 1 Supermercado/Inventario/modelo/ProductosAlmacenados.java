...
public class ProductosAlmacenados extends ProductoInv{
	...
	public ProductosAlmacenados(int precio, String marca, float cantidad, int codigobarras, int precioxunidad, int unidades, String nombre, String unidadmed) {
		super(precio, marca, cantidad, codigobarras, unidades, nombre, unidadmed, false, false);
		this.productoalm = true;
		this.empacados = new ProductosEmpacados(precioxunidad);
		this.noempacados = null;
	}
	public ProductosAlmacenados(int precio, String marca, float cantidad, int codigobarras, int unidades, String nombre, String unidadmed) {
		super(precio, marca, cantidad, codigobarras, unidades, nombre, unidadmed, false,false);
		this.productoalm = true;
		this.empacados = null;
