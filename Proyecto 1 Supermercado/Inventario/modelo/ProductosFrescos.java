...
public class ProductosFrescos extends ProductoInv{
	...
	public ProductosFrescos(int precio, String marca, float cantidad, int codigobarras, boolean refrigeracion, boolean congelacion, int precioxunidad, int unidades, String nombre, String unidadmed) {
		super(precio, marca, cantidad, codigobarras,unidades, nombre, unidadmed, refrigeracion, congelacion);
		this.congelacion = congelacion;
		this.refrigeracion = refrigeracion;
		empacados = new ProductosEmpacados(precioxunidad);
		noempacados = null;
	}
	public ProductosFrescos(int precio, String marca, float cantidad, int codigobarras, boolean refrigeracion, boolean congelacion, int unidades, String nombre, String unidadmed) {
		super(precio, marca, cantidad, codigobarras, unidades, nombre, unidadmed, refrigeracion, congelacion);
		this.congelacion = congelacion;
		this.refrigeracion = refrigeracion;
		empacados = null;
